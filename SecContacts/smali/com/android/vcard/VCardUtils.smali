...
.method public static constructListFromValue(Ljava/lang/String;I)Ljava/util/List;
    ...
    .line 508
    .local v12, nextCh:C
    invoke-static/range {p1 .. p1}, Lcom/android/vcard/VCardConfig;->isVersion40(I)Z
    ...
    .line 509
    invoke-static {v12}, Lcom/android/vcard/VCardParserImpl_V40;->unescapeCharacter(C)Ljava/lang/String;

    move-result-object v16

    .line 520
    .local v16, unescapedString:Ljava/lang/String;
    :goto_1
    if-eqz v16, :cond_3
    ...
    .end local v16           #unescapedString:Ljava/lang/String;
    :goto_2
    add-int/lit8 v7, v7, 0x1
    ...
    :cond_0
    invoke-static/range {p1 .. p1}, Lcom/android/vcard/VCardConfig;->isVersion30(I)Z
    ...
    .line 511
    invoke-static {v12}, Lcom/android/vcard/VCardParserImpl_V30;->unescapeCharacter(C)Ljava/lang/String;

    move-result-object v16

    .restart local v16       #unescapedString:Ljava/lang/String;
    goto :goto_1

    .line 513
    .end local v16           #unescapedString:Ljava/lang/String;
    :cond_1
    invoke-static/range {p1 .. p1}, Lcom/android/vcard/VCardConfig;->isVersion21(I)Z
    ...
    const-string v18, "Unknown vCard type"

    invoke-static/range {v17 .. v18}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    .line 517
    :cond_2
    invoke-static {v12}, Lcom/android/vcard/VCardParserImpl_V21;->unescapeCharacter(C)Ljava/lang/String;
    ...
    .line 548
    .local v14, tmp_V:Ljava/lang/String;
    const/4 v5, 0x0
    ...
    .line 558
    .local v15, type_value:Ljava/lang/String;
    const/16 v17, 0x0
    ...
    .line 564
    .end local v5           #checker:I
    .end local v6           #cnt:I
    .end local v8           #j:I
    .end local v11           #list2:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    .end local v13           #param_value:Ljava/lang/String;
    .end local v14           #tmp_V:Ljava/lang/String;
    .end local v15           #type_value:Ljava/lang/String;
    :cond_a
    :goto_6
    return-object v11

    .line 555
    .restart local v5       #checker:I
    .restart local v6       #cnt:I
    .restart local v8       #j:I
    .restart local v11       #list2:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    .restart local v14       #tmp_V:Ljava/lang/String;
    :cond_b
    const-string v17, ";"
