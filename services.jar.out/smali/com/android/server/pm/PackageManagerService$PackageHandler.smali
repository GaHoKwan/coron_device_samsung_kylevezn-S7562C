...
.method doHandleMessage(Landroid/os/Message;)V
    ...
    .line 872
    .local v36, ubmsg:Landroid/os/Message;
    ...
    .line 880
    .end local v36           #ubmsg:Landroid/os/Message;
    :cond_7
    move-object/from16 v0, p0
    ...
    .line 990
    iget-object v11, v15, Lcom/android/server/pm/PackageManagerService$PostInstallData;->args:Lcom/android/server/pm/PackageManagerService$InstallArgs;
    ...
    .line 1002
    :cond_12
    iget-object v2, v11, Lcom/android/server/pm/PackageManagerService$InstallArgs;->installerPackageName:Ljava/lang/String;
    ...
    .line 1005
    .local v14, cp:Lcom/sec/enterprise/knox/certificate/CertificatePolicy;
    if-eqz v14, :cond_13

    const/4 v2, 0x0

    invoke-virtual {v14, v2}, Lcom/sec/enterprise/knox/certificate/CertificatePolicy;->isSignatureIdentityInformationEnabled(Z)Z
    ...
    .line 1010
    .end local v14           #cp:Lcom/sec/enterprise/knox/certificate/CertificatePolicy;
    :cond_13
    ...
    check-cast v35, Lcom/android/server/pm/PackageVerificationState;

    .line 1096
    .local v35, state:Lcom/android/server/pm/PackageVerificationState;
    if-eqz v35, :cond_0

    .line 1097
    invoke-virtual/range {v35 .. v35}, Lcom/android/server/pm/PackageVerificationState;->getInstallArgs()Lcom/android/server/pm/PackageManagerService$InstallArgs;
    ...
    .end local v11           #args:Lcom/android/server/pm/PackageManagerService$InstallArgs;
    .end local v32           #ret:I
    .end local v35           #state:Lcom/android/server/pm/PackageVerificationState;
    ...
    .line 1113
    .restart local v35       #state:Lcom/android/server/pm/PackageVerificationState;
    if-nez v35, :cond_1e
    ...
    .line 1122
    invoke-virtual/range {v35 .. v35}, Lcom/android/server/pm/PackageVerificationState;->isVerificationComplete()Z
    ...
    .line 1128
    .restart local v11       #args:Lcom/android/server/pm/PackageManagerService$InstallArgs;
    invoke-virtual/range {v35 .. v35}, Lcom/android/server/pm/PackageVerificationState;->isInstallAllowed()Z
    ...
    .line 1155
    .end local v11           #args:Lcom/android/server/pm/PackageManagerService$InstallArgs;
    .end local v30           #response:Lcom/android/server/pm/PackageVerificationResponse;
    .end local v32           #ret:I
    .end local v35           #state:Lcom/android/server/pm/PackageVerificationState;
    .end local v40           #verificationId:I
    :pswitch_e
    ...
    check-cast v35, Lcom/android/server/pm/PackageScanState;

    .line 1158
    .local v35, state:Lcom/android/server/pm/PackageScanState;
    if-eqz v35, :cond_0

    .line 1159
    invoke-virtual/range {v35 .. v35}, Lcom/android/server/pm/PackageScanState;->getInstallArgs()Lcom/android/server/pm/PackageManagerService$InstallArgs;
    ...
    .end local v18           #e:Landroid/os/RemoteException;
    .end local v32           #ret:I
    .end local v33           #scanId:I
    .end local v35           #state:Lcom/android/server/pm/PackageScanState;
    :pswitch_f
    move-object/from16 v0, p1
    ...
    .line 1182
    .restart local v35       #state:Lcom/android/server/pm/PackageScanState;
    if-nez v35, :cond_21
