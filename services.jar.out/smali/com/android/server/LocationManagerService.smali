...
.method static synthetic access$1700(Lcom/android/server/LocationManagerService;Ljava/lang/String;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1900(Lcom/android/server/LocationManagerService;Landroid/app/PendingIntent;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2000(Lcom/android/server/LocationManagerService;)Ljava/util/ArrayList;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2400(Lcom/android/server/LocationManagerService;)Landroid/content/pm/PackageManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2502(Lcom/android/server/LocationManagerService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2600(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/GeocoderProxy;
    .locals 1
    .parameter "x0"
...
.method private removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    const-string v23, "Location requesting stopped by "
    ...
    const-string v23, "Receiver info:"
    ...
    .line 1589
    .local v13, oldRecords:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    if-eqz v13, :cond_6
    ...
    .line 1595
    invoke-interface {v14, v5}, Lcom/android/server/location/LocationProviderInterface;->removeListener(I)V
    ...
    .end local v13           #oldRecords:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    ...
    const-string v22, "Location requesting stopped by an application"
    ...
    .restart local v13       #oldRecords:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    ...
    invoke-interface {v14, v11, v12, v0}, Lcom/android/server/location/LocationProviderInterface;->setMinTime(JLandroid/os/WorkSource;)V

    goto/16 :goto_3

    .line 1627
    .end local v11           #minTime:J
    :cond_9
    const-string v21, "LocationManagerService"
    ...
    invoke-interface {v14, v0}, Lcom/android/server/location/LocationProviderInterface;->enableLocationTracking(Z)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
...
.method private requestLocationUpdatesLocked(Ljava/lang/String;JFZLcom/android/server/LocationManagerService$Receiver;)V
    ...
    check-cast v23, Lcom/android/server/location/LocationProviderInterface;

    .line 1429
    .local v23, p:Lcom/android/server/location/LocationProviderInterface;
    if-nez v23, :cond_2
    ...
    .line 1405
    .end local v23           #p:Lcom/android/server/location/LocationProviderInterface;
    :cond_1
    const-string v4, "LocationManagerService"
    ...
    .line 1433
    .restart local v23       #p:Lcom/android/server/location/LocationProviderInterface;
    :cond_2
    ...
    .line 1469
    .local v22, oldRecord:Lcom/android/server/LocationManagerService$UpdateRecord;
    if-eqz v22, :cond_3
    ...
    .line 1480
    .local v19, minTimeForProvider:J
    ...
    invoke-interface/range {v23 .. v23}, Lcom/android/server/location/LocationProviderInterface;->requestSingleShotFix()Z
    ...
    .line 1496
    .end local v19           #minTimeForProvider:J
    :cond_6
    :goto_4
    ...
    .end local v18           #isProviderEnabled:Z
    .end local v21           #newUid:Z
    .end local v22           #oldRecord:Lcom/android/server/LocationManagerService$UpdateRecord;
    :cond_7
    const/16 v21, 0x0
    ...
    .restart local v18       #isProviderEnabled:Z
    .restart local v19       #minTimeForProvider:J
    .restart local v21       #newUid:Z
    .restart local v22       #oldRecord:Lcom/android/server/LocationManagerService$UpdateRecord;
    :cond_8
    :try_start_1
    const-string v4, ""
