...
.method public onClick(Lcom/sec/android/glview/TwGLView;)Z
    ...
    .line 323
    iget-object v1, p0, Lcom/sec/android/app/camera/glwidget/TwGLHDRMenu;->mModeButton:Lcom/sec/android/glview/TwGLButton;

    if-ne p1, v1, :cond_3

    .line 324
    const-string v1, "TwGLHDRMenu"

    const-string v4, "mHDRmodeButton clicked Change mode"
    ...
    const-string v3, "HDRshot is Capturing"
    ...
    .line 331
    :cond_0
    iget v1, p0, Lcom/sec/android/app/camera/glwidget/TwGLHDRMenu;->mHDRMode:I

    if-nez v1, :cond_2

    .line 332
    iput v3, p0, Lcom/sec/android/app/camera/glwidget/TwGLHDRMenu;->mHDRMode:I
    ...
    invoke-virtual {v1, v3}, Lcom/sec/android/app/camera/Camera;->setHDRShotModeChanged(I)V
    ...
    invoke-virtual {v1, v3}, Lcom/sec/android/app/camera/Camera;->onHDRModeSelect(I)V

    .line 335
    iget-object v1, p0, Lcom/sec/android/app/camera/glwidget/TwGLHDRMenu;->mModeButton:Lcom/sec/android/glview/TwGLButton;

    iget-object v4, p0, Lcom/sec/android/app/camera/glwidget/TwGLHDRMenu;->mActivityContext:Lcom/sec/android/app/camera/AbstractCameraActivity;

    iget-object v5, p0, Lcom/sec/android/app/camera/glwidget/TwGLHDRMenu;->mHDRText:[I
    ...
    sget v5, Lcom/sec/android/app/camera/glwidget/TwGLHDRMenu;->HDRSHOT_BUTTON_TEXT_SIZE:I
    ...
    invoke-virtual {v1, v4, v5, v6, v2}, Lcom/sec/android/glview/TwGLButton;->setText(Ljava/lang/String;FIZ)V
    ...
    invoke-virtual {v1, v2}, Lcom/sec/android/app/camera/Camera;->setHDRShotModeChanged(I)V
    ...
    invoke-virtual {v1, v2}, Lcom/sec/android/app/camera/Camera;->onHDRModeSelect(I)V
    ...
    iget-object v5, p0, Lcom/sec/android/app/camera/glwidget/TwGLHDRMenu;->mActivityContext:Lcom/sec/android/app/camera/AbstractCameraActivity;
    ...
    invoke-static {v1, v4, v5, v6}, Lcom/sec/android/app/camera/command/CommandBuilder;->buildCommand(ILcom/sec/android/app/camera/AbstractCameraActivity;Lcom/sec/android/glview/TwGLViewGroup;Lcom/sec/android/app/camera/MenuResourceDepot;)Lcom/sec/android/app/camera/command/MenuCommand;
