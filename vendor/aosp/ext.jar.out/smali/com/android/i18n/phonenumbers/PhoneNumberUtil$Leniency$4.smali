...
.method verify(Lcom/android/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/lang/String;Lcom/android/i18n/phonenumbers/PhoneNumberUtil;)Z
    ...
    invoke-static {p2}, Lcom/android/i18n/phonenumbers/PhoneNumberUtil$Leniency;->access$300(Ljava/lang/String;)Z

    move-result v7

    if-nez v7, :cond_0

    #calls: Lcom/android/i18n/phonenumbers/PhoneNumberUtil$Leniency;->isNationalPrefixPresentIfRequired(Lcom/android/i18n/phonenumbers/Phonenumber$PhoneNumber;Lcom/android/i18n/phonenumbers/PhoneNumberUtil;)Z
    invoke-static {p1, p3}, Lcom/android/i18n/phonenumbers/PhoneNumberUtil$Leniency;->access$200(Lcom/android/i18n/phonenumbers/Phonenumber$PhoneNumber;Lcom/android/i18n/phonenumbers/PhoneNumberUtil;)Z
    ...
    invoke-static {p2, v5}, Lcom/android/i18n/phonenumbers/PhoneNumberUtil;->access$500(Ljava/lang/String;Z)Ljava/lang/StringBuilder;

    move-result-object v4

    .line 541
    .local v4, normalizedCandidate:Ljava/lang/StringBuilder;
    invoke-static {}, Lcom/android/i18n/phonenumbers/PhoneNumberUtil;->access$600()Ljava/util/regex/Pattern;
    ...
    invoke-static {p3, p1}, Lcom/android/i18n/phonenumbers/PhoneNumberUtil$Leniency;->access$400(Lcom/android/i18n/phonenumbers/PhoneNumberUtil;Lcom/android/i18n/phonenumbers/Phonenumber$PhoneNumber;)[Ljava/lang/String;
