...
.method public static buildNetworkIdentity(Landroid/content/Context;Landroid/net/NetworkState;)Landroid/net/NetworkIdentity;
    ...
    .line 154
    .local v5, roaming:Z
    invoke-static {v1}, Landroid/net/MultiSimConnectivityManager;->isNetworkTypeMobile(I)Z
    ...
    invoke-static {v1}, Landroid/net/MultiSimConnectivityManager;->getSimSlotFromTypeMobile(I)I

    move-result v9

    invoke-static {v0, v9}, Lcom/android/internal/telephony/MultiSimManager;->appendSimSlot(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 159
    .local v7, telephony:Landroid/telephony/MultiSimTelephonyManager;
    invoke-virtual {v7}, Landroid/telephony/MultiSimTelephonyManager;->isNetworkRoaming()Z
    ...
    .line 177
    .end local v7           #telephony:Landroid/telephony/MultiSimTelephonyManager;
    :cond_0
    :goto_0
    ...
    .line 163
    .restart local v7       #telephony:Landroid/telephony/MultiSimTelephonyManager;
    :cond_1
...
.method public toString()Ljava/lang/String;
    ...
    invoke-static {v2}, Landroid/net/MultiSimConnectivityManager;->getNetworkTypeName(I)Ljava/lang/String;
