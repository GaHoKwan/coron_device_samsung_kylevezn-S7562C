...
.method constructor <init>(Lcom/android/mms/data/WorkingMessage;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;Lcom/android/mms/data/Conversation;)V
    ...
    iput-object p2, p0, Lcom/android/mms/data/WorkingMessage$7;->val$uri:Landroid/net/Uri;

    iput-object p3, p0, Lcom/android/mms/data/WorkingMessage$7;->val$selection:Ljava/lang/String;

    iput-object p4, p0, Lcom/android/mms/data/WorkingMessage$7;->val$selectionArgs:[Ljava/lang/String;

    iput-object p5, p0, Lcom/android/mms/data/WorkingMessage$7;->val$conv:Lcom/android/mms/data/Conversation;
...
.method public run()V
    ...
    invoke-static {v3}, Lcom/android/mms/data/WorkingMessage;->access$600(Lcom/android/mms/data/WorkingMessage;)Landroid/content/Context;

    move-result-object v3

    iget-object v4, p0, Lcom/android/mms/data/WorkingMessage$7;->this$0:Lcom/android/mms/data/WorkingMessage;
    ...
    iget-object v5, p0, Lcom/android/mms/data/WorkingMessage$7;->val$uri:Landroid/net/Uri;

    iget-object v6, p0, Lcom/android/mms/data/WorkingMessage$7;->val$selection:Ljava/lang/String;

    iget-object v7, p0, Lcom/android/mms/data/WorkingMessage$7;->val$selectionArgs:[Ljava/lang/String;
