.class public Lcom/nbi/map/search/event/EventSearchRequest;
...
# direct methods
.method public constructor <init>(Lcom/nbi/common/NBIContext;Lcom/nbi/map/search/event/EventSearchRequest;Lcom/nbi/map/search/event/EventSearchInformation;BLcom/nbi/map/search/event/EventSearchListener;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/nbi/map/search/event/EventSearchRequest;->getInternalObject()Ljava/lang/Object;
    ...
    invoke-interface {p3}, Lcom/nbi/map/search/event/EventSearchInformation;->getInternalObject()Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p5, v0}, Lcom/nbi/map/search/event/EventSearchRequest;->a(Lcom/nbi/common/NBIContext;Lcom/nbi/map/search/event/EventSearchListener;Lnbisdk/hr;)V
...
.method public constructor <init>(Lcom/nbi/common/NBIContext;Lcom/nbi/map/search/event/EventSummarySearchInformation;Lcom/nbi/map/search/event/EventSummarySearchRequest;IILcom/nbi/map/search/event/EventSearchListener;)V
    .locals 6
    ...
    invoke-interface {p2}, Lcom/nbi/map/search/event/EventSummarySearchInformation;->getResultCount()I
    ...
    invoke-virtual {p3}, Lcom/nbi/map/search/event/EventSummarySearchRequest;->getInternalObject()Ljava/lang/Object;
    ...
    invoke-interface {p2, p4}, Lcom/nbi/map/search/event/EventSummarySearchInformation;->getEventSummary(I)Lcom/nbi/map/data/EventSummary;
    ...
    invoke-direct {p0, p1, p6, v0}, Lcom/nbi/map/search/event/EventSearchRequest;->a(Lcom/nbi/common/NBIContext;Lcom/nbi/map/search/event/EventSearchListener;Lnbisdk/hr;)V
...
.method private a(Lcom/nbi/common/NBIContext;Lcom/nbi/map/search/event/EventSearchListener;Lnbisdk/hr;)V
    .locals 2

    new-instance v0, Lcom/nbi/map/search/event/c;

    invoke-direct {v0, p0, p2}, Lcom/nbi/map/search/event/c;-><init>(Lcom/nbi/map/search/event/EventSearchRequest;Lcom/nbi/map/search/event/EventSearchListener;)V
    ...
    iput-object v1, p0, Lcom/nbi/map/search/event/EventSearchRequest;->kv:Lnbisdk/ah;
...
.method public cancelRequest()V
    ...
    iget-object v0, p0, Lcom/nbi/map/search/event/EventSearchRequest;->kv:Lnbisdk/ah;
...
.method public startRequest()V
    ...
    iget-object v1, p0, Lcom/nbi/map/search/event/EventSearchRequest;->kv:Lnbisdk/ah;
